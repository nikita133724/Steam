...
class PocketPawSocket {
    ...
    saveSettings(settings) {
        this.send('settings', {
            ...
            open_interpreter_provider: settings.openInterpreterProvider,
            open_interpreter_model: settings.openInterpreterModel,
            open_interpreter_history_messages: settings.openInterpreterHistoryMessages,
            open_interpreter_history_chars: settings.openInterpreterHistoryChars,
            open_interpreter_max_tokens: settings.openInterpreterMaxTokens,
            open_interpreter_requests_per_minute: settings.openInterpreterRequestsPerMinute,
            open_interpreter_registry_mode: settings.openInterpreterRegistryMode,
            open_interpreter_provider_registry: settings.openInterpreterProviderRegistry,
            openai_api_keys: settings.openaiApiKeys,
            groq_api_keys: settings.groqApiKeys,
